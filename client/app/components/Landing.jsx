...
function Landing() {
  return (
    <div className="w-full h-full flex flex-col justify-center  gap-y-2  items-center mx-auto px-8">
      ...
      <div className="z-10 flex mt-16 items-center justify-center">
        <div
          className={cn(
            "group rounded-full border border-black/5 bg-violet-500  text-white transition-all ease-in hover:cursor-pointer hover:bg-violet-400  "
          )}
        >
          <AnimatedShinyText className="inline-flex items-center justify-center px-4 py-1 transition ease-out bg-violet-500 text-white hover:duration-300 ">
        ...
        <section className="  dark:bg-gray-900">
          <div className="py-8 px-4 mx-auto    max-w-screen-xl text-center lg:mb-2 lg:px-12">
            ...
            <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
              <a
                href="#"
                className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-violet-500 hover:bg-violet-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900"
              >
                Learn more
                <svg
              ...
              <a
                href="#"
                className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-violet-200 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
              >
                <svg
      ...
      <div className="w-full">
        <div className="mx-auto max-w-3xl px-4 mt-[-200] sm:px-6 sm:py-12 lg:px-8">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
            <div className="rounded-2xl border border-violet-600 p-6 shadow-xs ring-1 ring-violet-600 sm:order-last sm:px-8 lg:p-12">
        ...
        <footer class="bg-white mb-20 dark:bg-gray-900">
          <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
              <div class="mb-6 px-2 md:mb-0">
                <a href="https://flowbite.com/" class="flex gap-2 items-center">
